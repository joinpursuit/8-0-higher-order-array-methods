 ...
 */
//creates a function to get song titles with the parameter songs which is an array
 function getSongTitles(songs) {
   //using the map method on the array songs return the iteration 
   return  songs.map((song) => {
     //return iteration of song title 
     return song.title
   })
 }
 ...
 */
//creat a function to get the tite and artist with the parameter songs which is an array
function getTitleAndArtist(songs) {
  //using the map method on the array songs and return the iteration 
  return songs.map((song) => ({
    //of song title and song artist as an object 
