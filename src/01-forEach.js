 ...
 */
const titles = (printAllSongTitles = (songs) =>
 ...
 *  //> ...
 */
const titleAndArtist = (printSongDetails = (songs) =>
 ...
 * @param {Object[]} songs - An array of songs. See the song data for more.
 */
const time = (printSongTitlesOverThreeMinutes = (songs) =>
  songs.forEach((song) =>
    song.runtimeInSeconds > 180 ? console.log(song.title) : undefined
  ));
