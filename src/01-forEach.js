...
const printAllSongTitles = (songs) => {
  //for each iteration through the songs array console the title at that iteration
...
const printSongDetails = (songs) => {
  //for each iteration through the array songs console the interpolation of the song title at that iteration by the song artist
...
const printSongTitlesOverThreeMinutes = (songs) => {
  ...
  songs.forEach((song) => {
  //conditional statement if the song runtimeInSeconds at the iteration is greater than or equal to 180
