...
function sortByArtistNameDescending(songs) {
  return songs.sort((firstSong, secondSong) => {
    const firstLowered = firstSong.artist.toLowerCase();
    const secondLowered = secondSong.artist.toLowerCase();
...
function sortBySongTitleAscending(songs) {
  return songs.sort((firstSong, secondSong) => {
    firstLowered = firstSong.title.toLowerCase();
    secondLowered = secondSong.title.toLowerCase();
    if (firstLowered < secondLowered) {
      return -1;
