/*
  ...
  you may use the `exampleSongData` variable below 
  to gain access to tickets data. This data is pulled from 
  ...
  Keep in mind that your functions must still have and 
  use a parameter for accepting all songs.
*/
 ...
 *
 * TIP: "A" and "a" sort differently. To avoid this issue, 
 * you may want to use `.toLowerCase()` or `.toUpperCase()`.
 *
 * @param {Object[]} songs - An array of songs. See the song data for more.
 * @returns {Object[]}
 */
